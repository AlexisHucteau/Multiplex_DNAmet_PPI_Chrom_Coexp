...
rgl::snapshot3d("Results/multiplex.png", fmt = "png", width = 1024, height = 1024)
```
...
pal.aggr <- sample(viridis(commResult2$modules.aggr))

png("Results/multi_sbm_infomap_table2.png", width = 1024, height = 728 / 2,
    res = 100)
gplt <- plot_multimodules(commResult2, module.colors = pal.mux,
                          show.aggregate = T)
dev.off()
```
