...
```{r}
Multiplex_test <- buildMultilayerNetworkFromMuxvizFiles(config.file = "MuxViz_multiplex/Multiplex_function_config.txt", MultisliceType = "ordinal", isWeighted = T, isDirected = T, verbose = T)
```
