...
NR_R_reaction_enrichment <- dplyr::filter(NR_R_reaction_enrichment, statistic > summary(NR_R_reaction_enrichment$statistic)[5] | statistic < summary(NR_R_reaction_enrichment$statistic)[3])
